    ...
    <section id="faq" className="py-24 sm:py-32">
      <div className="mx-auto grid max-w-7xl gap-12 px-5 sm:px-8 lg:grid-cols-[0.75fr_1.25fr] lg:gap-20">
        <Reveal>
          ...
          <a href="mailto:info@aounalruwad.com" className="mt-8 inline-flex items-center gap-2 rounded-2xl border border-primary/15 bg-brand-soft/55 px-5 py-3 text-sm font-bold text-primary transition-colors hover:bg-brand-soft"><MessageCircle className="h-4 w-4" /> تواصل مع الدعم</a>
        </Reveal>
