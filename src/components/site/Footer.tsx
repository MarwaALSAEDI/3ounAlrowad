...
const columns = [
  ...
  { title: "عيون الرواد", links: ["من نحن", "علاماتنا", "الفروع", "الوظائف", "تواصل معنا"] },
    ...
    <footer className="dark bg-background text-foreground">
      <Stagger gap={0.08} className="mx-auto max-w-7xl px-5 py-16 sm:px-8 sm:py-20">
        <div className="grid gap-12 lg:grid-cols-[1.45fr_repeat(3,1fr)]">
          <motion.div variants={itemVariants}>
            ...
            <ul className="mt-6 space-y-3 text-sm text-muted-foreground">
              ...
              <li><a href="mailto:info@oyoonalrowad.com" className="inline-flex items-center gap-3 transition-colors hover:text-primary"><Mail className="h-4 w-4" /> info@oyoonalrowad.com</a></li>
        ...
        <motion.div variants={itemVariants} className="mt-14 flex flex-col-reverse items-center justify-between gap-6 border-t border-border pt-7 sm:flex-row">
          <p className="text-center text-xs text-muted-foreground sm:text-right">© ٢٠٢٦ عيون الرواد. جميع الحقوق محفوظة.</p>
