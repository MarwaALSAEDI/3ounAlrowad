...
const reviews = [
  ...
  { name: "محمد الشمري", role: "أكثر من ٧ طلبات", initials: "م ش", color: "bg-emerald-100 text-emerald-700", review: "الأسعار واضحة والتجربة سلسة جداً. جهزت أغلب أجهزة مطبخي من بيت الراحة ولم أواجه أي مشكلة." },
